...
@Component({
  selector: 'app-infant-b',
  templateUrl: './infant-b.page.html',
  styleUrls: ['./infant-b.page.scss'],
})
export class InfantBPage implements OnInit {

  public infantBaptismForm !: FormGroup;
  ...
  ngOnInit(): void {
    this.infantBaptismForm = this.formBuilder.group({
  ...
  infantBaptism() {
    this.http.post<any>("http://localhost:3000/infantBaptismRecord", this.infantBaptismForm.value)
    .subscribe(async res=>{
      const alert = await this.alertController.create({
        header: 'Success!',
        message: 'Infant Baptism Successfully Reserved!',
        buttons: ['OK'],
      });
      await alert.present()

      this.infantBaptismForm.reset();
